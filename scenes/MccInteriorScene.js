...
export default class MccInteriorScene extends Phaser.Scene {
  constructor() {
    super("MccInteriorScene");
  }
  ...
  create() {
    ...
    const map = this.make.tilemap({ key: 'mcctilemap'});
    const tileset = map.addTilesetImage('groundset', 'tiles');
    // const mccSideTileset = map.addTilesetImage('MccSideTileset', 'MccSideImg');
    const hylandClassroomTileset = map.addTilesetImage('HylandClassroomTileset', 'HylandClassroomImg');
